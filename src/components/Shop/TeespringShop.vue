  ...
  <div class="">
    <div class="grid grid-cols-2 mt-4 mx-auto sm:container ">
      <div class="flex">
        ...
        <div class="border ml-8 hidden sm:flex">
          <div class="pt-3 px-3 bg-white"><img class="" style="width: 15px; height: 15px" src="../../assets/image/search-magnifier-outline-svgrepo-com.svg" alt="">
          </div>
          <input type="text" placeholder="search the marketplace "
                 class="py-2 outline-none w-64 placeholder-font-light">
        </div>
      </div>
      <div class="justify-end text-sm items-center hidden sm:flex">
        <a href="" class="font-light mr-8 hover:text-red-700">Start Designing</a>
        <a href="" class="font-medium text-red-700">Login</a>
      </div>
      <div class="sm:hidden flex justify-end mt-3 mr-6"><img style="width: 15px; height: 15px" src="../../assets/image/search-magnifier-outline-svgrepo-com.svg" alt=""></div>
    </div>
    <div class="grid grid-cols-1 border mt-3">
      <div class="flex my-3 mx-auto container">
        <ul>
          <li>
