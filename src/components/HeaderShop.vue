  ...
  <div class="">
      ...
      <div class="flex">
        ...
        <div class="border ml-8 hidden lg:flex">
          <div class="pt-3 px-3 bg-white">
            <img src="../assets/image/search-magnifier-outline-svgrepo-com.svg" height="15" width="15" />
          </div>
    ...
    <div class="grid-cols-1 mt-3 border-b hidden lg:grid">
      <div class="flex mx-auto container mb-3">
        <ul>
          <li>
            <router-link to="/Apparel"><a class="font-light text-sm text-gray-700 " href="">Apparel</a></router-link>
